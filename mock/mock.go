...
func (m *MockGameInterface) Input() (domain.Koma, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGameInterfaceMockRecorder) Input() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Input", reflect.TypeOf((*MockGameInterface)(nil).Input))
}
